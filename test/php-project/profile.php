...
$avatar_path = "uploads/" . $username . "/" . $username . ".jpg"; // Assuming the avatar is stored as a .jpg file

if (!file_exists($avatar_path)) {
    $avatar_path = "uploads/default.jpg"; // Path to a default avatar if the user's avatar does not exist
}
...
<head>
    ...
    <style>
        ...
        .avatar { display: block; margin: 0 auto 15px; width: 100px; height: 100px; border-radius: 50%; object-fit: cover; }
    </style>
</head>
<body>
