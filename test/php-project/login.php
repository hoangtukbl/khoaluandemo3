...
if (file_exists($avatar_path)) {
    ...
    $avatar_url = "uploads/default-avatar.jpg"; // Path to a default avatar if the user's avatar does not exist
}
...
<head>
    ...
    <style>
        ...
        .avatar { display: block; margin: 0 auto 15px; border-radius: 50%; width: 100px; height: 100px; object-fit: cover; }
    </style>
</head>
<body>
